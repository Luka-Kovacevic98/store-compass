...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn("flex h-full w-full flex-col overflow-hidden rounded-2xl text-card-foreground", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <div className="flex items-center gap-2 border-b border-white/15 px-3" cmdk-input-wrapper="">
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ...
    className={cn(
      ...
      "data-[selected=true]:bg-white/15 data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50",
      className,
    )}
    {...props}
  />
